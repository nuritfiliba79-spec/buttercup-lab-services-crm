...
- **לוח בקרה** – מדדים, דוחות, בדיקות פתוחות לפי יעד (כולל סימון בדיקות באיחור) וקבצים אחרונים.
- **חיווי קבצים מצורפים** – מונה 📎 לכל פרויקט, הזמנה ובדיקה, וסימון **חדש** לקבצים שמישהו אחר העלה מאז הביקור האחרון שלך בפרויקט. כשמועלה קובץ חדש מופיעה התראה.
- **הכל בזמן אמת** – כל המסכים מתעדכנים מיד כשמשהו משתנה: לקוחות, פרויקטים, הזמנות, בדיקות, דוחות, קבצים, מעבדות ומשתמשים. העדכונים נשלחים רק למי שמורשה לראות אותם (Realtime + RLS). אם המשתמש באמצע הקלדה או בחירת קובץ, הריענון מחכה שיסיים.
